...
class MainActivityTest2 {
    ...
    fun mainActivityTest2() {
        ...
        textInputEditText2.perform(replaceText("9624078932"), closeSoftKeyboard())
        ...
        textInputEditText3.perform(replaceText("keshv bag society "), closeSoftKeyboard())
